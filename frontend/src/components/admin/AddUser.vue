  ...
  <div class="list row">
    <div class="col-md-8">
      ...
      <form>
        <div class="form-group">
          ...
          <input type="text" class="form-control my-2" id="Name" v-model="Name" />
          <p class="small text-warning">{{ nameMessage }}</p>
        </div>

        <div class="form-group">
          <label for="URI">E-mail</label>
          <input type="text" class="form-control my-2" id="Email" v-model="Email" />
          ...
          <div class="btn-group">
            <ul class="px-0 btn-group-sm">
              <li
                ...
                >{{ item.name }} <span v-bind:id="index" class="badge small bg-primary">x</span></li
              >
            </ul>
          </div>
        </div>
    ...
    <div class="col-md-4">
      <div class="btn-group btn-group-sm my-2" role="group">
        <button type="submit" class="btn btn-outline-primary" @click="createUser" :disabled="sending">
          Create
        </button>
      </div>
