...
ServiceList.create = (newServiceList, result) => {
  ...
  sql.query(
    "INSERT INTO ServiceListOffering SET Provider = ?, regulatorList = ?, Delivery = ?,Status = ?",
    [newServiceList.ProviderId, newServiceList.regulatorList, deliveries, newServiceList.Status],
    async (err, res) => {
      if (err) {
...
ServiceList.findById = (ListId, result) => {
  sql.query(
    `SELECT ServiceListOffering.Id,ServiceListOffering.Provider,ServiceListOffering.Delivery, ServiceListOffering.Status, ServiceListOffering.regulatorList FROM ServiceListOffering WHERE ServiceListOffering.Id = ?`,
    [ListId],
    async (err, res) => {
      if (err) {
        console.log("error: ", err);
...
ServiceList.getAllByStatus = async (result, liststatus = "active", provider = null) => {
  ...
  // using query params
  if (provider)
    query = `SELECT ServiceListOffering.Id,ServiceListOffering.Provider,ServiceListOffering.Delivery, ServiceListOffering.Status, ServiceListOffering.regulatorList FROM ServiceListOffering WHERE ServiceListOffering.Status = ? AND ServiceListOffering.Provider = ?`;
  else
    query = `SELECT ServiceListOffering.Id,ServiceListOffering.Provider,ServiceListOffering.Delivery, ServiceListOffering.Status, ServiceListOffering.regulatorList FROM ServiceListOffering WHERE ServiceListOffering.Status = ?`;
...
ServiceList.getAllByProvider = async (provider, result) => {
  sql.query(
    `SELECT ServiceListOffering.Id,ServiceListOffering.Provider,ServiceListOffering.Delivery, ServiceListOffering.Status, ServiceListOffering.regulatorList FROM ServiceListOffering where ServiceListOffering.Provider = ?`,
    [provider],
    async (err, res) => {
      if (err) {
        console.log("error: ", err);
...
ServiceList.getAll = async (result) => {
  sql.query(
    "SELECT ServiceListOffering.Id,ServiceListOffering.Provider,ServiceListOffering.Delivery, ServiceListOffering.Status, ServiceListOffering.regulatorList FROM ServiceListOffering ORDER BY ServiceListOffering.Id",
    async (err, res) => {
      if (err) {
        console.log("error: ", err);
        result(null, err);
...
async function removeRelatedTables(list) {
  ...
  promises.push(
    removeAllListEntries(list, "ServiceListName").catch((err) => {
      console.log("ServiceListName failed");
    })
  );
  promises.push(
    removeAllListEntries(list, "ServiceListURI").catch((err) => {
      console.log("ServiceListURI failed");
    })
  );
  promises.push(
